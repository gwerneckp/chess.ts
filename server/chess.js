...
class Chess {
    ...
    static inCheckAfterMove(x1, y1, x2, y2, board, moveType, turn, promote) {
    ...
    static changePieceLocation(board, x1, y1, x2, y2, moveType, promote) {
    ...
    static getTurn(turn, opponent = false) {
        // if (turn % 2 == 1)
        if (opponent) {
            turn = turn + 1;
        }
